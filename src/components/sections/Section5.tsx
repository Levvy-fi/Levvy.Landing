    ...
    return (
        <section className="flex items-center justify--center relative px-4">
            <div className="relative w-full mt-[120px] sm:mt-[210px] lg:mt-[300px]">
                <div className="absolute left-1/2 transform -translate-x-1/2 -z-10 w-full -top-34 sm:-top-56 lg:-top-54 xl:-top-75 2xl:w-[1536px]">
                    <img
                ...
                >
                    <div className="flex items-center justify-center absolute inset-x-0 z-20 -top-15 sm:-top-24">
                        <div className="aspect-square w-32 sm:w-50">
                            <img
                                src="/images/section6/angel_coin.webp"
                                alt="angel coin"
                            />
                        </div>
                    </div>
                    ...
                    >
                        <div className="absolute opacity-20 w-500">
                            <img
                                src="/images/section6/card_bg.webp"
